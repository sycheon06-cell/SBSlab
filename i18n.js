    ...
    const betaTools = {
        building: {
            ...
            ko: {
                ...
                detailText: '웹에서 건물 모델을 설정하고 EnergyPlus 시뮬레이션 결과를 검토할 수 있는 베타 웹 앱입니다. 브라우저 기반 건물 에너지 해석 워크플로우를 초기 테스트하는 단계입니다.',
                launch: '앱 열기'
            }
        },
        optimization: {
            ...
            ko: {
                status: '<i class="fas fa-flask"></i> 베타 웹 앱',
                cardText: '범용 설계 최적화, 파라미터 연구, trade-off 분석을 지원하는 베타 웹 앱입니다.',
                detailText: '설계 변수, 제약조건, 목적함수, trade-off를 함께 다루는 범용 최적화 베타 웹 앱입니다.',
                launch: '앱 열기'
            }
        }
    };
